...
export function NewsList() {
  ...
  return (
    <section className="selection-teal w-full px-6 pb-24 pt-36 md:px-[126px] md:pb-[156px] md:pt-44" style={{ background: "#006960" }}>
            ...
            {visible < items.length && (
              <div className="mt-16 flex justify-center">
                <button
                  ...
                  className="inline-flex w-full cursor-pointer items-center justify-center rounded-full bg-[#ffba68] px-8 py-3.5 font-semibold text-[#1f1d1b] transition-all duration-300 hover:bg-[#ffc985] sm:w-auto md:hover:scale-105"
                  style={FONT}
                >
                  {t.loadMore}
                </button>
